        ...
        <div className="bg-white rounded-2xl p-8 lg:p-12 shadow-xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">
              Get custom loan amounts and plans tailored to your specific needs with super-affordable interest rates as low as <span className="font-bold text-purple-600">0.2% per month</span>
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Custom Amounts</h4>
              <p className="text-gray-600 text-sm">Loan amounts tailored to your exact financial needs</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Flexible Terms</h4>
              <p className="text-gray-600 text-sm">Repayment plans designed around your schedule</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Low Interest</h4>
              <p className="text-gray-600 text-sm">Starting from just 0.2% monthly interest rate</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Smart approval process with instant decisions</p>
            </div>
          </div>
        </div>
      </div>
